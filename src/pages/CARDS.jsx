...
const Cards = () => {
    return (
      <div class="text-white p-4 d-flex flex-column justify-content-center align-content-center gap-3">
...
<li class='cord'>
 <div class="gap-2 animals bg-slate-800 rounded-lg p-8 dark:bg-slate-800k bg-opacity-10 bg-slate-300 " style={{'minWidth':'480px', 'maxWidth':'480px'}}>
  <div class="card-body">

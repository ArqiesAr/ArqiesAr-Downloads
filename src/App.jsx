...
function App() {
  return (
    ...
    <nav id="navbar" class="navbar navbar-dark bg-dark rounded-full bg-opacity-75 navbar-fixed-top shadow-5-strong navbar-expand-lg ml-auto" data-bs-theme="dark">
